...
class NotaCredito extends Model implements Auditable
{
    ...
    protected $table = 'ventas.NOTAS_CREDITO';
    ...
    /**
     * Calcula los totales de la nota de crédito basándose en los detalles
     */
    ...
    public function emitir($usuarioId = null)
    {
        ...
        try {
            ...
            if ($this->factura->estado !== 'EMITIDA') {
                throw new \Exception('La factura debe estar emitida para aplicar una nota de crédito.');
            }
