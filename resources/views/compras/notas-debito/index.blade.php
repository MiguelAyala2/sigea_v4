    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                <a href="{{ route('compras.notas-debito.create') }}" class="btn btn-success btn-sm">
                ...
                <tbody>
                    @forelse($notasDebito as $nota)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('compras.notas-debito.show', $nota) }}" class="btn btn-info btn-sm">
                                    <i class="fas fa-eye"></i>
                                </a>
                                @if($nota->estado === 'borrador')
                                    <a href="{{ route('compras.notas-debito.edit', $nota) }}" class="btn btn-primary btn-sm">
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="text-center">No hay notas de débito registradas</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
