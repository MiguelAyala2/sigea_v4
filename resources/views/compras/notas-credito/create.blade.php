...
@section('content')
    <form action="{{ route('compras.notas-credito.store') }}" method="POST">
        @csrf
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <select name="motivo" id="motivo" class="form-control @error('motivo') is-invalid @enderror" required>
                                ...
                                <option value="Devolución de mercadería defectuosa o equivocada">Devolución de mercadería defectuosa o equivocada</option>
                                <option value="Descuentos posteriores a la factura">Descuentos posteriores a la factura</option>
                                <option value="Corrección de sobrefacturación">Corrección de sobrefacturación</option>
                                <option value="Bonificaciones acordadas después">Bonificaciones acordadas después</option>
                            </select>
                            @error('motivo')
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label for="numero">Número de Nota de Crédito *</label>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="observaciones" id="observaciones" rows="2" class="form-control" placeholder="Información adicional sobre la nota de crédito"></textarea>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <a href="{{ route('compras.notas-credito.index') }}" class="btn btn-secondary">Cancelar</a>
            </div>
        </div>
    </form>
@stop
...
function cargarComprasPorProveedorFecha() {
    ...
    $.ajax({
        url: '{{ route('compras.notas-credito.api.compras-por-proveedor-fecha') }}',
        method: 'GET',
        data: {
...
function cargarDetallesCompra(compraId) {
    $.ajax({
        url: `/compras/notas-credito/api/compra/${compraId}/detalles`,
        method: 'GET',
