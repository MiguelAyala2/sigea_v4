<div>
    ...
    <x-adminlte-card theme="warning" title="Editar Tipo de Servicio" icon="fas fa-edit" collapsible>
        <form wire:submit.prevent="actualizar">
            <div class="row">
                <div class="col-md-3">
                    <x-adminlte-input name="codigo" label="Código *" wire:model="codigo"
                        placeholder="No editable" disabled enable-old-support error-key="codigo">
