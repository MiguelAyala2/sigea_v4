<div>
    ...
    <x-adminlte-card theme="primary" title="Datos de Recepción" icon="fas fa-clipboard-check" collapsible>
        <form wire:submit.prevent="guardar">
            <div class="row">
                <div class="col-md-3">
                    <x-adminlte-input name="numero_recepcion" label="N° Recepción"
                        value="{{ App\Models\Servicios\Recepcion::generarNumeroRecepcion() }}" disabled>
