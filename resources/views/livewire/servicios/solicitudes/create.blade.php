<div>
    ...
    <x-adminlte-card theme="light" title="Nueva Solicitud de Servicio" icon="fas fa-clipboard-list">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        @if($mostrarListaProductos && count($productosEncontrados) > 0)
                            <div class="list-group mt-1" style="position: absolute; z-index: 1000; width: 94%;">
