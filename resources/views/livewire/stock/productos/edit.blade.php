<div>
    ...
    <x-adminlte-card theme="light" title="Editar Producto" icon="fas fa-edit">
        <form wire:submit="guardar">
            <div class="row">
                ...
                @if(!empty($imagenes_existentes))
                    <div class="col-md-12">
                        <p class="text-muted"><small>Imágenes actuales del producto:</small></p>
                        <div class="row">
                            @foreach($imagenes_existentes as $imagen)
                                <div class="col-md-3 mb-3">
                                    <div class="card">
                                        <img src="{{ asset('storage/' . $imagen['path']) }}" class="card-img-top" style="height: 150px; object-fit: cover;">
                                        <div class="card-body p-2">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="custom-control custom-radio">
                                                    <input type="radio"
                                                           class="custom-control-input"
                                                           id="principal_existente_{{ $imagen['id'] }}"
                                                           wire:click="establecerPrincipalExistente({{ $imagen['id'] }})"
                                                           {{ $imagen_principal_id == $imagen['id'] ? 'checked' : '' }}>
                                                    <label class="custom-control-label" for="principal_existente_{{ $imagen['id'] }}">
                                                        <small>Principal</small>
                                                    </label>
                                                </div>
                                                <button type="button"
                                                        wire:click="eliminarImagenExistente({{ $imagen['id'] }})"
                ...
                @if(!empty($imagenes))
                    <div class="col-md-12">
                        <p class="text-muted"><small>Nuevas imágenes a agregar:</small></p>
                        <div class="row">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body p-2">
                                            <div class="d-flex justify-content-end">
                                                <button type="button"
                                                        wire:click="eliminarImagenNueva({{ $index }})"
                                                        class="btn btn-sm btn-danger">
                                                    <i class="fas fa-trash"></i>
                                                </button>
                                            </div>
