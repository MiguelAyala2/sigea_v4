<div>
    ...
    <x-adminlte-card theme="light" title="Editar Punto de Expedición" icon="fas fa-edit">
        <form class="row" wire:submit="guardar">
            ...
            <div class="form-group col-md-3">
                <x-adminlte-button type="submit" label="Actualizar Punto de Expedición" theme="outline-success" icon="fas fa-save" class="w-100 btn-sm" />
            </div>
        </form>
    </x-adminlte-card>
</div>
