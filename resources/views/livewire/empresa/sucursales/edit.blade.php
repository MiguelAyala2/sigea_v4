<div>
    ...
    <x-adminlte-card theme="light" title="Editar Sucursal" icon="fas fa-edit">
        <form class="row" wire:submit="guardar">
            ...
            <div class="form-group col-md-3">
                <x-adminlte-button type="submit" label="Actualizar Sucursal" theme="outline-success" icon="fas fa-save" class="w-100 btn-sm" />
            </div>
        </form>
    </x-adminlte-card>
</div>
