<div>
    ...
    <x-adminlte-card theme="light" title="Editar Timbrado" icon="fas fa-edit">
        <form class="row" wire:submit="guardar">
            ...
            <x-adminlte-input name="numero_actual" value="{{ number_format($numero_actual, 0, '', '.') }}"
                type="text"
                readonly
                fgroup-class="col-md-4" igroup-size="sm">
                <x-slot name="prependSlot"><div class="input-group-text bg-secondary">Número Actual</div></x-slot>
            </x-adminlte-input>
            ...
            <div class="form-group col-md-3">
                <x-adminlte-button type="submit" label="Actualizar Timbrado" theme="outline-success" icon="fas fa-save" class="w-100 btn-sm" />
            </div>
        </form>
    </x-adminlte-card>
</div>
