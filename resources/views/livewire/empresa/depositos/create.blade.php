<div>
    ...
    <x-adminlte-card theme="light" title="Crear Depósito" icon="fas fa-plus">
        <form class="row" wire:submit="guardar">
            ...
            <div class="form-group col-md-3">
                <label>
                    <input type="checkbox" wire:model="permite_venta" checked> Permite Venta
                </label>
            </div>
            ...
            <div class="form-group col-md-3">
                <x-adminlte-button type="submit" label="Crear Depósito" theme="outline-success" icon="fas fa-save" class="w-100 btn-sm" />
            </div>
        </form>
    </x-adminlte-card>
</div>
