...
El sistema utiliza **Spatie Permission** con una estructura jerárquica de permisos organizados por módulos:

#### Permisos de Administración
- **Usuarios**: Ver, Crear, Editar, Eliminar, Asignar Rol, Activar/Inactivar, Reset Contraseña
- **Roles**: Ver, Crear, Editar, Eliminar

#### Permisos de Módulo Compras
- **Compras**: Ver, Crear, Editar, Eliminar, Aprobar, Revisar
- **Proveedores**: Ver, Crear, Editar, Eliminar
- **Órdenes Compra**: Ver, Crear, Editar, Eliminar, Aprobar

#### Permisos de Módulo Servicios
- **Servicios**: Ver, Crear, Editar, Eliminar, Aprobar
- **Instalaciones**: Ver, Crear, Editar, Ejecutar
- **Órdenes Servicio**: Ver, Crear, Editar, Aprobar

#### Permisos de Módulo Ventas
- **Ventas**: Ver, Crear, Editar, Eliminar, Aprobar
- **Clientes**: Ver, Crear, Editar, Eliminar
- **Cotizaciones**: Ver, Crear, Editar, Aprobar
- **Facturas**: Ver, Crear, Editar, Anular
- **Caja**: Ver, Abrir, Cerrar, Cobrar
...
- **Reportes**: Ver, Compras, Servicios, Ventas, Financieros
...
#### NIVEL 0: SuperAdmin
- **Descripción**: Acceso total y absoluto al sistema
- **Permisos**: TODOS los permisos del sistema
- **Restricciones**: Solo para desarrollo y mantenimiento crítico

#### NIVEL 1: Administrador del Sistema
- **Descripción**: Gestión completa del sistema y todos los módulos operativos
- **Permisos**:
  - Gestión de usuarios (crear, editar, asignar roles, reset contraseña)
  - Gestión de roles (crear, editar)
  - Acceso total a Compras, Servicios, Ventas con aprobación
  - Acceso total a Inventario y Productos
  - Todos los reportes incluyendo financieros
  - Configuración del sistema

#### NIVEL 2: Gerencia
**Gerente General**
- Aprobación en todos los módulos (Compras, Servicios, Ventas)
- Visualización completa de operaciones
- Acceso a reportes financieros

**Supervisor General**
- Similar a Gerente General pero sin reportes financieros

#### NIVEL 3: Encargados (Aprobadores por Módulo)

**Encargado de Compras**
- CRUD completo de compras y proveedores
- Aprobación de compras y órdenes de compra
- Acceso a inventario y productos (vista)
- Reportes de compras

**Encargado de Servicios**
- CRUD completo de servicios e instalaciones
- Aprobación de servicios y órdenes de servicio
- Gestión de clientes
- Ejecutar instalaciones
- Reportes de servicios

**Encargado de Ventas**
- CRUD completo de ventas, clientes, cotizaciones
- Aprobación de ventas y cotizaciones
- Gestión completa de facturas (crear, editar, anular)
- Gestión de caja (abrir, cerrar)
- Reportes de ventas

#### NIVEL 4: Supervisores (Revisores/Ejecutores)

**Supervisor de Compras**
- CRUD de compras y proveedores
- Revisar compras (sin aprobar)
- Crear órdenes de compra (sin aprobar)

**Supervisor Técnico**
- CRUD de servicios e instalaciones
- Ejecutar instalaciones
- Crear órdenes de servicio (sin aprobar)

**Asistente de Ventas**
- CRUD de ventas, clientes, cotizaciones
- Crear facturas (sin anular)
- Vista de inventario

#### NIVEL 5: Asistentes (Operativos)

**Asistente de Compras**
- Crear compras y proveedores
- Crear órdenes de compra
- Vista de inventario

**Asistente Instalador**
- Vista de servicios y órdenes
- Ejecutar instalaciones
- Vista de clientes y productos

**Cajero**
- Gestión de caja (abrir, cerrar, cobrar)
- Crear facturas
- Vista de ventas y clientes
- Vista de productos

### Usuarios de Ejemplo en Seeder

El archivo [RolYPermisoSeeder.php](database/seeders/RolYPermisoSeeder.php) crea los siguientes usuarios:
...
#### Usuarios Operativos (Contraseña: `12345678` para todos)
...
Permiso::create(['name' => 'Usuarios Ver']);
```
...
$rol = Rol::create(['name' => 'Nombre del Rol']);
$rol->syncPermissions([
    'Usuarios Ver',
    'Usuarios Crear',
    'Usuarios Editar',
...
#### Verificar Permisos en Blade

```blade
@can('Usuarios Ver')
    <a href="{{ route('admin.usuarios.index') }}">Ver Usuarios</a>
@endcan

@role('SuperAdmin')
    <button>Solo SuperAdmin</button>
@endrole
```
...
#### Verificar Permisos en Controladores/Livewire
...
// En constructor (para Controladores)
public function __construct()
{
...
### Comandos Útiles para Roles y Permisos
