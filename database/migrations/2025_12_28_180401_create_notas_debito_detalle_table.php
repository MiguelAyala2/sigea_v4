...
return new class extends Migration
{
    ...
    {
        Schema::create('ventas.NOTAS_DEBITO_DETALLE', function (Blueprint $table) {
            $table->id();

            // Relaciones
            $table->unsignedBigInteger('nota_debito_id')->comment('Nota de débito a la que pertenece');
            $table->unsignedBigInteger('factura_detalle_id')->nullable()->comment('Detalle de factura relacionado');
            $table->unsignedBigInteger('producto_id')->comment('Producto del cargo/ajuste');
            ...
            $table->text('descripcion_adicional')->nullable()->comment('Descripción adicional');
            ...
            $table->foreign('nota_debito_id')
                ->references('id')
                ->on('ventas.NOTAS_DEBITO')
                ->onDelete('cascade');
        });
    }
    ...
    {
        Schema::dropIfExists('ventas.NOTAS_DEBITO_DETALLE');
    }
};
