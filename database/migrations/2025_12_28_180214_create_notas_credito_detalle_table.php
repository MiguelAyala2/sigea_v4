...
return new class extends Migration
{
    ...
    {
        Schema::create('ventas.NOTAS_CREDITO_DETALLE', function (Blueprint $table) {
            $table->id();

            // Relaciones
            $table->unsignedBigInteger('nota_credito_id')->comment('Nota de crédito a la que pertenece');
            $table->unsignedBigInteger('factura_detalle_id')->nullable()->comment('Detalle de factura relacionado');
            $table->unsignedBigInteger('producto_id')->comment('Producto de la devolución/ajuste');
    ...
    {
        Schema::dropIfExists('ventas.NOTAS_CREDITO_DETALLE');
    }
};
