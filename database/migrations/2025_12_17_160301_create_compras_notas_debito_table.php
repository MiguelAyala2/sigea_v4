...
return new class extends Migration
{
    ...
    {
        Schema::create('compras.notas_debito', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('compras.notas_debito_detalle', function (Blueprint $table) {
            $table->id();
            $table->foreignId('nota_debito_id')->constrained('compras.notas_debito')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('compras.notas_debito_detalle');
        Schema::dropIfExists('compras.notas_debito');
    }
};
